# -*- coding: utf-8 -*-
"""Copia de Ejercicios01.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gBH8PMtimM4xauULIJ-OUBQ25H3LZr6T
...
# Función a ser evaluada
y = lambda x: np.exp *np.cos(x)
#y1= np.exp(1)**x (np.cos(x)-np.sen(x))
#y2= -2*(np.exp(1)**x)*np.sen(x)
p2 = lambda x: 1+x
ea = np.fabs(y(0.5)-p2(0.5))
print (ea) 
...
Ea = np.fabs(np.exp(1) - 2.718)
print (Ea)
Er = Ea / np.fabs(np.exp(1)) 
print (Er)

Ea = np.fabs(np.math.factorial(8) - 39900)
print (Ea)
Er = Ea / np.fabs(np.math.factorial(8)) 
print (Er)

Ea = np.fabs(np.math.sqrt(2) - 1.4142)
print (Ea)
Er = Ea / np.fabs(np.sqrt(2)) 
print (Er)

Ea = np.fabs(np.math.sqrt(2) - 1.4142)
print (Ea)
Er = Ea / np.fabs(np.math.sqrt(2)) 
print (Er)

Ea = np.fabs((4/5 + 1/3)-round(ea,3))
print (Ea)
Er = Ea / np.fabs((4/5 + 1/3)) 
print (Er)
